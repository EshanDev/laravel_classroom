        ...
        <div id="SidebarContainer" class="sidebar">
            <div class="content">
                ...
                <div class="sidebar-header">
                    <h3 class="text-center mp-none">
                        <i class="glyph-icon flaticon-001-workplace"></i>
                        ห้องเรียน
                    </h3>
                </div>
                <!-- End Content One -->
                ...
                <div class="sidebar-list">
                    <ul id="SLink" class="sidebar-link">
                        <li>
                            <router-link to="/classroom">หน้าหลัก</router-link>
                        </li>
                        <li>
                            <router-link to="/classroom/profile"
                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-links">
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item nav-link">Administrator</li>
                        </ul>
                    </div>
                </div>
            </nav>
...
.router-link-active {
    ...
    border-left: 5px solid var(--sidebar-header);
